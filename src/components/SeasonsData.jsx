  ...
  return (
    <div>
      ...
      <p>
        ...
        <p>
          <br />
          <strong>Achtung:</strong> Wenn deine Hündin dünnflüssiges und helleres
          Blut ausscheidet, ist das ein klares Anzeichen für die Deckfähigkeit
          deiner Hündin.
        </p>
      </p>
      <h2> Diöstrus (Nachbrunst)</h2>
      <p>
        Unabhängig davon, ob deine Hündin schwanger ist oder nicht, beginnt nun
        der Diöstrus und dauert in etwa <strong>63 Tage</strong> . Die Vulva ist
        nun nicht mehr geschwollen und der Ausfluss ist verschwunden. Falls eine
        Befruchtung der Eizellen stattgefunden hat, endet der Diöstrus mit der
        Geburt der Welpen.
      </p>
